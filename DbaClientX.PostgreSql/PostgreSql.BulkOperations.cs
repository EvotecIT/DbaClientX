...
public partial class PostgreSql
{
    ...
    /// <summary>
    /// Asynchronously disposes a PostgreSQL connection created for the current operation.
    /// </summary>
    protected virtual ValueTask DisposeConnectionAsync(NpgsqlConnection connection)
    {
