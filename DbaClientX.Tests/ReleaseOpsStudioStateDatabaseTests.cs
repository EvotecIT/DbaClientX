...
using ReleaseOpsStudio.Orchestrator.Storage;

namespace DBAClientX.Tests;

public sealed class ReleaseOpsStudioStateDatabaseTests
{
    [Fact]
    public async Task PersistPortfolioSnapshotAsync_RoundTripsGitHubAndDriftSignals()
    {
        var testDirectory = Path.Combine(Path.GetTempPath(), "ReleaseOpsStudioTests");
