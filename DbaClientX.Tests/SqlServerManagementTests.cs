...
public class SqlServerManagementTests
{
    ...
    public void TableScriptColumnQuery_PreservesMaskingAndTemporalHistoryMetadata()
    {
        ...
        string modulesQuery = InvokePrivateStaticString<SqlServer>("BuildSqlServerModuleScriptsManagementQuery", true, true);
        string noClrModulesQuery = InvokePrivateStaticString<SqlServer>("BuildSqlServerModuleScriptsManagementQuery", true, false);
        string legacyModulesQuery = InvokePrivateStaticString<SqlServer>("BuildSqlServerModuleScriptsManagementQuery", false, false);
        ...
        Assert.Contains("OBJECT_ID(N'sys.function_order_columns')", databaseClrSupportQuery);
