...
internal static class SqlServerManagementMappers
{
    ...
    public static SqlServerTableColumnScriptInfo MapTableScriptColumn(IDataRecord record)
        => new()
        {
            ...
            GraphColumnRole = GetString(record, "GraphColumnRole"),
            ...
            HistoryRetentionPeriod = GetNullableInt32(record, "HistoryRetentionPeriod"),
            HistoryRetentionPeriodUnit = GetString(record, "HistoryRetentionPeriodUnit"),
            LedgerViewSchema = GetString(record, "LedgerViewSchema"),
            LedgerViewName = GetString(record, "LedgerViewName"),
            LedgerTransactionIdColumnName = GetString(record, "LedgerTransactionIdColumnName"),
            LedgerSequenceNumberColumnName = GetString(record, "LedgerSequenceNumberColumnName"),
            LedgerOperationTypeColumnName = GetString(record, "LedgerOperationTypeColumnName"),
            LedgerOperationTypeDescriptionColumnName = GetString(record, "LedgerOperationTypeDescriptionColumnName"),
