...
$LibrariesByFolder = @{
    'Core' = @(
        ...
        'Lib\Core\Dapper.dll'
        'Lib\Core\DbaClientX.dll'
        'Lib\Core\Humanizer.dll'
        'Lib\Core\SqlKata.dll'
        'Lib\Core\SqlKata.Execution.dll'
        'Lib\Core\System.Data.SqlClient.dll'
    )
    'Default' = @(
        'Lib\Default\DbaClientX.PowerShell.dll'
        'Lib\Default\Dapper.dll'
        'Lib\Default\DbaClientX.dll'
        'Lib\Default\Humanizer.dll'
        'Lib\Default\SqlKata.dll'
        'Lib\Default\SqlKata.Execution.dll'
        'Lib\Default\System.Data.SqlClient.dll'
    )
}
