...
/// <example>
/// <summary>Cancel a refresh returned by Invoke-FabricXPowerBIRefresh.</summary>
/// <prefix>PS&gt; </prefix>
/// <code>$refresh | Stop-FabricXPowerBIRefresh -TokenProvider $powerBiProvider -Confirm</code>
/// <para>Cancellation is never performed by discovery or settlement commands.</para>
/// </example>
[Cmdlet(VerbsLifecycle.Stop, "FabricXPowerBIRefresh", SupportsShouldProcess = true, ConfirmImpact = ConfirmImpact.High)]
[OutputType(typeof(FabricResponse))]
[CmdletBinding()]
public sealed class CmdletStopFabricXPowerBIRefresh : AsyncPSCmdlet
{
    ...
    /// <summary>Accepted refresh returned by Invoke-FabricXPowerBIRefresh.</summary>
